...
import { Difficulty, State, Value, InputMode } from "../models.ts";
import getNewSudoku from "../utils/getNewSudoku.ts";
import { getValidatedState } from "../utils/validationUtils.ts";

import useHasWon from "./useHasWon.tsx";
import useHistory from "./useHistory.tsx";

const useSudokuStateManager = () => {
  const initialSudokuState = useRef<State>(
    getNewSudoku(Difficulty.Hard)
  ).current;
